                           ...
                           (
                             ...
                             (
                                            sidebarPanel
                                             ...
                                             (
                                               ...
                                               conditionalPanel(condition = 'input.deli_easyanova == "dic_easyanova" && input.metodologia == "easyanova"',
                                                              ...
                                                              cat("significancia para dic easyanova")
                               ...
                               mainPanel(
                                 ...
                                 ######################################################
                                 conditionalPanel(condition = "input.deli == 'dic' || input.deli_easyanova == 'dic_easyanova",
                           ...
                           (
                             ...
                             (
                                        sidebarPanel
                                              ...
                                              conditionalPanel(condition = "input.deli == 'dbc' & input.metodologia == 'expDes'",
                                                 ...
                                                 conditionalPanel(condition = "input.deli_easyanova == 'dbc_easyanova' & input.metodologia == 'easyanova",
                                                                   #Intervalo de Teste F
                                                                   sliderInput("sigF_easy_dbc", "Selecione o nível de significância",min = 1, value = 10, max = 20, post = "%")
                               ...
                               mainPanel(
                                 ...
                                 ######################################################
                                 conditionalPanel(condition = "input.deli_easyanova == 'dbc_easyanova'",
                                                  htmlOutput("uidbcmodelos"),
                                                  cat("ui dbc modelos - start")
                                              #    input.deli == 'dbc' ||  
                                     )
                               )
                             ),
